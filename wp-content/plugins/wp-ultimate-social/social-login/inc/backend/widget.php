...
/**
 * Adds Ultimate Social Login Widget
 */
...
class APSL_Widget extends WP_Widget {
    ...
    function __construct() {
        parent::__construct(
                'apsl_widget', // Base ID
                __('Ultimate Social Login', APSL_TEXT_DOMAIN ), // Name
                array('description' => __('Ultimate Social Login Widget', APSL_TEXT_DOMAIN )) // Args
        );
    }
    ...
    public function widget($args, $instance) {
        ...
        echo do_shortcode("[us-social-login theme='{$instance['theme']}' login_text='{$instance['login_text']}']");
        echo "</div>";
        }

...
if (! class_exists('StringNew') ) {
    final class StringNew {
        ...
        public function concat() {
            ...
            foreach ($strs as $str) {
                if (!($str instanceof String)) {
                    $str = new StringNew($str);
                }
                $temp[] = $str->value;
            }
            return new StringNew($this->value . implode('', $temp));
        ...
        */
        ...
        public static function fromCharCode() {
            ...
            return new StringNew($str->value);
        ...
        */
        ...
        public function quote($single = FALSE) {
            ...
            return new StringNew($quote . $this->value . $quote);
        ...
        */
        ...
        /*
        * Returns a new StringNew resulting from replacing all occurrences of old in
        ...
        */
        ...
        /*
        * Returns a new StringNew that is a substring of this string.
        * 
        * @access  public
        * @param   int
        * @param   int
        ...
        */
        ...
        public function toLowerCase() {
            ...
            return new StringNew(strtolower($this->value));
        ...
        */
        ...
        public function toUpperCase() {
            ...
            return new StringNew(strtoupper($this->value));
        ...
        */
        ...
        public function delRightMost($sSearch) {
            ...
            for ($i = strlen($sSource); $i >= 0; $i = $i - 1) {
                ...
                if ($f !== FALSE) {
                return new StringNew(substr($sSource,0, $f));
                break;
                }
            }
            return new StringNew($sSource);
        }
        ...
        */
        ...
        public function delLeftMost($sSearch) {
            ...
            for ($i = 0; $i < strlen($sSource); $i = $i + 1) {
                $f = strpos($sSource, $sSearch, $i);
                if ($f !== FALSE) {
                return new StringNew(substr($sSource,$f + strlen($sSearch), strlen($sSource)));
                break;
                }
            }
            return new StringNew($sSource);
        ...
        */
        ...
        public function left($chars){
            return new StringNew(substr($this->value, 0, $chars));
        }
        ...
        */
        ...
        public function right($chars){
            return new StringNew(substr($this->value, ($chars*-1)));   
        }
    }
}
?>

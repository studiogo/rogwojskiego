					...
					switch($key){
						//counter available for facebook
							...
							<div class='apss-facebook apss-single-icon'>
									<a rel='nofollow' <?php if($apss_link_open_option_value == '2'){ ?> onclick="apss_open_in_popup_window(event, '<?php echo $link; ?>');" <?php } ?> title='<?php if(isset($options['share_texts']['common-long-text']) && $options['share_texts']['common-long-text'] !='' ){ echo $options['share_texts']['common-long-text']; }else{ _e('Share on', APSS_TEXT_DOMAIN ); } ?> <?php echo ucfirst($key); ?>' target='<?php echo $apss_link_open_option; ?>' href='<?php echo $link; ?>'>
											<div class='apss-icon-block<?php if($icon_set_value != '4'){ ?> clearfix<?php } ?>'>
													<i class='fa fa-facebook'></i>
													<span class='apss-social-text'><?php if(isset($options['share_texts']['common-long-text']) && $options['share_texts']['common-long-text'] !='' ){ echo $options['share_texts']['common-long-text']; }else{ _e('Share on', APSS_TEXT_DOMAIN ); } ?> <?php echo ucfirst($key); ?></span>
							...
							<div class='apss-twitter apss-single-icon'>
								<a rel='nofollow' <?php if($apss_link_open_option_value == '2'){ ?> onclick="apss_open_in_popup_window(event, '<?php echo $link; ?>');" <?php } ?> title='<?php if(isset($options['share_texts']['twitter-long-text']) && $options['share_texts']['twitter-long-text'] !='' ){ echo $options['share_texts']['twitter-long-text']; }else{ _e('Share on', APSS_TEXT_DOMAIN ); } ?> <?php echo ucfirst($key); ?>' target='<?php echo $apss_link_open_option; ?>' href='<?php echo $link; ?>'>
									<div class='apss-icon-block<?php if($icon_set_value != '4'){ ?> clearfix<?php } ?>'>
										<i class='fa fa-twitter'></i>
										<span class='apss-social-text'><?php if(isset($options['share_texts']['twitter-long-text']) && $options['share_texts']['twitter-long-text'] !='' ){ echo $options['share_texts']['twitter-long-text']; }else{ _e('Share on', APSS_TEXT_DOMAIN ); } ?> <?php echo ucfirst($key); ?></span>
							...
							<div class='apss-google-plus apss-single-icon'>
								...
								<div class='apss-icon-block<?php if($icon_set_value != '4'){ ?> clearfix<?php } ?>'>
									...
									<span class='apss-social-text'><?php if(isset($options['share_texts']['common-long-text']) && $options['share_texts']['common-long-text'] !='' ){ echo $options['share_texts']['common-long-text']; }else{ _e( 'Share on', APSS_TEXT_DOMAIN ); } ?> <?php if(isset($options['apss_social_networks_naming'][$key]) && $options['apss_social_networks_naming'][$key] !='' ){ echo $options['apss_social_networks_naming'][$key]; }else{ echo 'Google Plus'; } ?></span>
									<span class='apss-share'><?php if(isset($options['share_texts']['common-short-text']) && $options['share_texts']['common-short-text'] !='' ){ echo $options['share_texts']['common-short-text']; }else{ _e('Share', APSS_TEXT_DOMAIN ); } ?></span>
								</div>
										<?php if(isset($counter_enable_options) && $counter_enable_options=='1'){ ?>
										<div class='count apss-count' data-url='<?php echo $url;?>' data-social-network='<?php echo $key; ?>' data-social-detail="<?php echo $url.'_'.$key;?>"><?php echo $formatted_count; ?></div>
							...
							<div class='apss-email apss-single-icon'>
								<a <?php if(isset($options['apss_email_share_popup_disable']) && $options['apss_email_share_popup_disable'] !='1'){ echo "class='share-email-popup'"; } ?> title='<?php if(isset($options['share_texts']['email-long-text']) && $options['share_texts']['email-long-text'] !='' ){ echo $options['share_texts']['email-long-text']; }else{ _e('Send email', APSS_TEXT_DOMAIN ); } ?>' target='<?php echo $apss_link_open_option; ?>' href='<?php echo $link; ?>'>
									<div class='apss-icon-block<?php if($icon_set_value != '4'){ ?> clearfix<?php } ?>'>

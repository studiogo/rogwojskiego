...
if ( ! class_exists( 'WPSEO_Local_Metaboxes' ) ) {
	...
	class WPSEO_Local_Metaboxes {
		...
		public function business_info_panel_content() {
			...
			echo '<p><label class="textinput" for="wpseo_business_address_2">' . esc_html__( 'Business address line 2', 'yoast-local-seo' ) . '</label>';
			...
			echo '</select></p>';
			echo '<p><label class="textinput" for="wpseo_business_phone">' . esc_html__( 'Business phone', 'yoast-local-seo' ) . '</label>';
			...
			echo '<p><label class="textinput" for="wpseo_business_phone_2nd">' . esc_html__( '2nd Business phone', 'yoast-local-seo' ) . '</label>';
			...
			echo '<p><label class="textinput" for="wpseo_business_fax">' . esc_html__( 'Business fax', 'yoast-local-seo' ) . '</label>';
			echo '<input type="text" name="_wpseo_business_fax" id="wpseo_business_fax" value="' . esc_attr( $this->location_meta['business_fax'] ) . '" /></p>';
			echo '<p><label class="textinput" for="wpseo_business_email">' . esc_html__( 'Business email', 'yoast-local-seo' ) . '</label>';
			...
			echo '<div class="wpseo-local-help-wrapper">';
			echo '<p><label class="textinput" for="wpseo_business_price_range">' . esc_html__( 'Price indication', 'yoast-local-seo' ) . ':' . $price_indication_help->get_button_html() . ' </label>';
			...
			echo '<div class="wpseo-local-help-wrapper">';
			echo '<p><label class="textinput" for="wpseo_business_area_served">' . esc_html__( 'Area served', 'yoast-local-seo' ) . ':' . $area_served_help->get_button_html() . ' </label>';
			...
			echo '<p class="yoast-local-seo-field-desc">' . esc_html__( 'Here you can enter the latitude and longitude coordinates yourself. If you\'ve entered a Google Maps API Key these coordinates will be automatically calculated. This API Key is also needed for the map to show on your site.', 'yoast-local-seo' ) . '</p>';
		...
		public function opening_hours_panel_content() {
			...
			echo '<div class="wpseo-local-help-wrapper">';
			echo '<p><label for="wpseo_map_location_id" class="textinput">' . esc_html__( 'Timezone:', 'yoast-local-seo' ) . $timezone_help->get_button_html() . ' </label>';
		...
		public function maps_settings_panel_content() {
			...
			if ( ! empty( $api_key ) ) {
				...
				echo '<p class="yoast-local-seo-field-desc">' . sprintf( __( 'This custom marker will override the custom markers for the location category and general %s settings', 'yoast-local-seo' ), 'Yoast Local SEO' ) . '</p>';
				echo '</div>';
				if ( ! empty( $custom_marker ) ) {
		 ...
		 *
		 * @param $label   string Is the translatable string in front of the check.
		 * @param $checked boolean Checking if the checkbox is checked and returns true or false.
		 * @param $name    string This is the ID which is saved by the database.
		 * @param $class   string The classname which can be used to change css or js.
		 *
		 * @return string
		 */
					...
					<div class="wrap">
						<div>
							...
							<div style="padding:15px 15px 0 15px;">
								...
								<label
									for="wpseo_sl_radius"><?php printf( esc_html__( 'Search radius (in %s)', 'yoast-local-seo' ), ( empty( $this->options['unit_system'] ) || $this->options['unit_system'] === 'METRIC' ) ? 'km' : 'mi' ); ?>

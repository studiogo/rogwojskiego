        ...
        <div class="aptf-single-tweet-wrapper1">
            <div class="aptf-tweet-content">
                <?php if ( $aptf_pro_settings['display_username'] == 1 ) { ?>
                    <a href="http://twitter.com/<?php echo $tweet->user->screen_name; ?>" class="aptf-tweet-name" target="_blank">
                        <img src="<?php echo str_replace('http://','https://',$tweet->user->profile_image_url); ?>" height="50px" width="50px"/>
                        <span class="aptf-screen-name"><?php echo $tweet->user->name; ?></span> @<span class="aptf-user-name"><?php echo $tweet->user->screen_name; ?></span>
                    </a>
                <?php } ?>

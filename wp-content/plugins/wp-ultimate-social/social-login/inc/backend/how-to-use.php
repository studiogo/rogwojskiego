...
<dl>
  ...
  <ul class="how-list">
    ...
    <li>Set user role: Here you can assign the users role. These roles will be assigned only to those user who have login/register through ultimate social login plugin.</li>
  ...
  <dd>
    <p>You can use shortcode for the display of the social logins in the contents of a posts and pages.
      <ul class="how-list">
        <li>Example 1: [us-social-login theme='2' login_text='Social Connect' login_redirect_url='<?php echo site_url(); ?>']</li>
        ...
        <li>Example 2: [us-social-login-with-login-form template='3' theme='1' login_text='Please login to site' login_redirect_url='<?php echo site_url(); ?>']</li>
        <li>Shortcode attributes: <br />

...
if (!defined('APSL_TEXT_DOMAIN')) {
    define('APSL_TEXT_DOMAIN', 'ultimate-social');
}
...
if (!class_exists('APSL_Class')) {
    ...
    class APSL_Class {
        ...
        function __construct() {
            ...
            add_shortcode('us-social-login', array($this, 'apsl_shortcode')); //adds a shortcode
            add_shortcode( 'us-social-login-with-login-form', array($this, 'apsl_with_login_form_shortcode') );
        ...
        function register_admin_assets() {
            ...
            if (isset($_GET['page']) && $_GET['page'] == 'us-social-login') {
        ...
        function add_social_login_form_to_comment() {
            ...
            if (!is_user_logged_in()) {
                ?>
                <?php
                echo do_shortcode("[us-social-login login_text='{$login_text}']");
            }
        }
        ...
        public function social_buttons_in_checkout($template_name) {
            if ($template_name == 'checkout/form-login.php') {
                ...
                if (!is_user_logged_in()) {
                    ...
                    <?php echo do_shortcode("[us-social-login login_text='{$login_text}']"); ?>
                    </form>
                        <?php
                    }
                }
            ...
            function apsl_restore_default_settings() {
                ...
                if (!empty($_GET) && wp_verify_nonce($nonce, 'apsl-restore-default-settings-nonce')) {
                    ...
                    wp_redirect(admin_url() . 'admin.php?page=us-social-login');
                    exit;
                } else {
                    die('No script kiddies please!');
                }

...
<div class='apss-sticky-header-wrapper'>
<?php
	$options = $this->apss_settings;
	$bitly_options = isset($options['bitly']) ? $options['bitly'] : array();

	if(isset($options['social_share_sticky_share']['image_url']) &&  $options['social_share_sticky_share']['image_url'] !=''){
		$sticky_header_site_logo = $options['social_share_sticky_share']['image_url'];
	}else{
		$sticky_header_site_logo = APSS_IMAGE_DIR. '/apss-sticky-share.png';
	}
?>
			...
			foreach( $options['social_networks'] as $key=>$value ){
				if( intval($value)=='1' ){
					...
					switch($key){
						...
						$formatted_count = APSS_Class:: get_formatted_count($count , $counter_type_options);
						?>
						<div class='apss-google-plus apss-single-icon apss-single-icon-small'>
							<a rel='nofollow' 
							<?php if($apss_link_open_option_value == '2'){ ?> 
										onclick="apss_open_in_popup_window(event, '<?php echo $link; ?>');" 
									<?php } ?>
						...
						<div class='apss-pinterest apss-single-icon apss-single-icon-small'>
						...
						$formatted_count = APSS_Class:: get_formatted_count($count , $counter_type_options);
						?>
						<div class='apss-linkedin apss-single-icon apss-single-icon-small'>
							<a rel='nofollow' 
								<?php if($apss_link_open_option_value == '2'){ ?> 
										onclick="apss_open_in_popup_window(event, '<?php echo $link; ?>');" 
									<?php } ?>
						...
						?>
						<div class='apss-digg apss-single-icon apss-single-icon-small'>
							<a rel='nofollow' 
								<?php if($apss_link_open_option_value == '2'){ ?> 
										onclick="apss_open_in_popup_window(event, '<?php echo $link; ?>');" 
									<?php } ?>
						...
						<div class='apss-delicious apss-single-icon apss-single-icon-small'>
							<a rel='nofollow' 
							<?php if($apss_link_open_option_value == '2'){ ?> 
										onclick="apss_open_in_popup_window(event, '<?php echo $link; ?>');" 
									<?php } ?>
						...
						<div class='apss-reddit apss-single-icon apss-single-icon-small'>
							<a rel='nofollow'
							<?php if($apss_link_open_option_value == '2'){ ?> 
										onclick="apss_open_in_popup_window(event, '<?php echo $link; ?>');" 
									<?php } ?> 
						...
						<div class='apss-stumbleupon apss-single-icon apss-single-icon-small'>
							<a rel='nofollow' 
							<?php if($apss_link_open_option_value == '2'){ ?> 
										onclick="apss_open_in_popup_window(event, '<?php echo $link; ?>');" 
									<?php } ?> 
						...
						?>
						<div class='apss-tumblr apss-single-icon apss-single-icon-small'>
							<a rel='nofollow' 
							<?php if($apss_link_open_option_value == '2'){ ?> 
										onclick="apss_open_in_popup_window(event, '<?php echo $link; ?>');"
									<?php } ?>
						...
						<div class='apss-vk apss-single-icon apss-single-icon-small'>
							<a rel='nofollow' 
								<?php if($apss_link_open_option_value == '2'){ ?> 
									onclick="apss_open_in_popup_window(event, '<?php echo $link; ?>');" 
								<?php } ?>
						...
						?>
						<div class='apss-xing apss-single-icon apss-single-icon-small'>
							<a rel='nofollow' 
							<?php if($apss_link_open_option_value == '2'){ ?> 
								onclick="apss_open_in_popup_window(event, '<?php echo $link; ?>');" 
							<?php } ?>
						...
						?>
						<div class='apss-weibo apss-single-icon apss-single-icon-small'>
							<a rel='nofollow'
							<?php if($apss_link_open_option_value == '2'){ ?> 
								onclick="apss_open_in_popup_window(event, '<?php echo $link; ?>');" 
							<?php } ?>
						...
						<div class='apss-buffer apss-single-icon apss-single-icon-small'>
							<a rel='nofollow'
							<?php if($apss_link_open_option_value == '2'){ ?> 
								onclick="apss_open_in_popup_window(event, '<?php echo $link; ?>');" 
							<?php } ?>
						...
						?>
						<div class='apss-whatsapp apss-single-icon apss-single-icon-small'>
								<a rel='nofollow'
								<?php if($apss_link_open_option_value == '2'){ ?> 
									onclick="apss_open_in_popup_window(event, '<?php echo $link; ?>');" 
								<?php } ?>
						...
						case 'email':
								...
								?>
						<div class='apss-email apss-single-icon apss-single-icon-small'>
						...
						case 'print':
						?>
						<div class='apss-print apss-single-icon apss-single-icon-small'>

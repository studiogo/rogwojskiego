        ...
        (
            [Facebook] => Array
                (
                    ...
                    [image] => http://192.168.1.70/ultimate-social/wp-content/plugins/ultimate-social/icon-sets/set1/facebook.png
                    [icon_width] => 20
                    [icon_height] => 20
                    [link] => facebook.com
            ...
            [Twitter] => Array
                (
                    [title] => Twitter
                    [icon_type] => image-icons
                    [image] => http://192.168.1.70/ultimate-social/wp-content/plugins/ultimate-social/icon-sets/set1/twitter.png
                    [icon_width] => 20
                    [icon_height] => 20
                    [link] => twitter.com
                    [link_target] => New Window
            ...
            [Youtube] => Array
                (
                    [title] => Youtube
                    [icon_type] => image-icons
                    [image] => http://192.168.1.70/ultimate-social/wp-content/plugins/ultimate-social/icon-sets/set1/youtube.png
                    [icon_width] => 20
                    [icon_height] => 20
                    [link] => youtube.com
                    [link_target] => New Window
...
$icon_extra = array('icon_set_type'=>$icon_set_type,
                    ...
                    'icon_theme_type'=>$icon_theme_type,
                    'num_columns'=>$num_columns,
                    'tooltip_position'=>$tooltip_position);
$icon_extra = serialize($icon_extra);
global $wpdb;
$icons = serialize($icons);
$table_name = $wpdb->prefix . "aps_social_icons_pro";
if(isset($si_id))
{
    $wpdb->update( 
	$table_name, 
...
$_SESSION['aps_message'] = __('Icon Set Updated Successfully',US_TD);
}
else
{
    $wpdb->insert( 
...
$_SESSION['aps_message'] = __('Icon Set Saved Successfully',US_TD);
}

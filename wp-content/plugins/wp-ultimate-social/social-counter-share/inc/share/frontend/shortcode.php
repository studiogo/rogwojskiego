...
if(isset($attr['alignment'])){
	$text_align = 'apss-buttons-'.$attr['alignment'];
}else{
	$text_align = 'apss-buttons-left';
}

?>

<div class='apss-social-share apss-theme-<?php echo $icon_set_value; ?> <?php if( $counter_enable_options=='1' ){echo 'counter-enable'; } ?> clearfix <?php echo $text_align; ?>' >
<?php
global $post;
	...
	if( intval($value)=='1' ){
		...
		switch($key){
			...
			<div class='apss-facebook apss-single-icon'>
					<a rel='nofollow' <?php if($apss_link_open_option_value == '2'){ ?> onclick="apss_open_in_popup_window(event, '<?php echo $link; ?>');" <?php } ?> title='<?php if(isset($options['share_texts']['common-long-text']) && $options['share_texts']['common-long-text'] !='' ){ echo $options['share_texts']['common-long-text']; }else{ echo "Share on"; } ?> <?php if(isset($options['apss_social_networks_naming'][$key]) && $options['apss_social_networks_naming'][$key] !='' ){ echo $options['apss_social_networks_naming'][$key]; }else{ echo ucfirst($key); } ?>' target='<?php echo $apss_link_open_option; ?>' href='<?php echo $link; ?>'>
			...
			<div class='apss-twitter apss-single-icon'>
				<a rel='nofollow' <?php if($apss_link_open_option_value == '2'){ ?> onclick="apss_open_in_popup_window(event, '<?php echo $link; ?>');" <?php } ?> title='<?php if(isset($options['share_texts']['twitter-long-text']) && $options['share_texts']['twitter-long-text'] !='' ){ echo $options['share_texts']['twitter-long-text']; }else{ echo "Share on"; } ?> <?php if(isset($options['apss_social_networks_naming'][$key]) && $options['apss_social_networks_naming'][$key] !='' ){ echo $options['apss_social_networks_naming'][$key]; }else{ echo ucfirst($key); } ?>' target='<?php echo $apss_link_open_option; ?>' href='<?php echo $link; ?>'>
					<div class='apss-icon-block<?php if($icon_set_value != '4'){ ?> clearfix<?php } ?>'>
			...
			<a rel='nofollow' <?php if($apss_link_open_option_value == '2'){ ?> onclick="apss_open_in_popup_window(event, '<?php echo $link; ?>');" <?php } ?> title='<?php if(isset($options['share_texts']['common-long-text']) && $options['share_texts']['common-long-text'] !='' ){ echo $options['share_texts']['common-long-text']; }else{ echo "Share on"; } ?> <?php if(isset($options['apss_social_networks_naming'][$key]) && $options['apss_social_networks_naming'][$key] !='' ){ echo $options['apss_social_networks_naming'][$key]; }else{ echo 'Google Plus'; } ?>' target='<?php echo $apss_link_open_option; ?>' href='<?php echo $link; ?>'>
				<div class='apss-icon-block<?php if($icon_set_value != '4'){ ?> clearfix<?php } ?>'>
			...
			<div class='apss-pinterest apss-single-icon'>
				<a rel='nofollow' title='<?php if(isset($options['share_texts']['common-long-text']) && $options['share_texts']['common-long-text'] !='' ){ echo $options['share_texts']['common-long-text']; }else{ echo "Share on"; } ?> <?php if(isset($options['apss_social_networks_naming'][$key]) && $options['apss_social_networks_naming'][$key] !='' ){ echo $options['apss_social_networks_naming'][$key]; }else{ echo ucfirst($key); } ?>' href='javascript:pinIt();'>
					<div class='apss-icon-block<?php if($icon_set_value != '4'){ ?> clearfix<?php } ?>'>
			...
			<div class='apss-fb-messenger apss-single-icon'>
					<a rel='nofollow' <?php if($apss_link_open_option_value == '2'){ ?> onclick="apss_open_in_popup_window(event, '<?php echo $link; ?>');" <?php } ?> title='<?php if(isset($options['share_texts']['common-long-text']) && $options['share_texts']['common-long-text'] !='' ){ echo $options['share_texts']['common-long-text']; }else{ _e('Share on', APSS_TEXT_DOMAIN ); } ?> <?php if(isset($options['apss_social_networks_naming'][$key]) && $options['apss_social_networks_naming'][$key] !='' ){ echo $options['apss_social_networks_naming'][$key]; }else{ echo ucfirst($key); } ?>' target='<?php echo $apss_link_open_option; ?>' href='<?php echo $link; ?>'>
							<div class='apss-icon-block<?php if($icon_set_value != '4'){ ?> clearfix<?php } ?>'><i class='fa fa-fb-messenger'></i>
									<span class='apss-social-text'><?php if(isset($options['share_texts']['common-long-text']) && $options['share_texts']['common-long-text'] !='' ){ echo $options['share_texts']['common-long-text']; }else{  _e( 'Share on', APSS_TEXT_DOMAIN ); } ?> <?php if(isset($options['apss_social_networks_naming'][$key]) && $options['apss_social_networks_naming'][$key] !='' ){ echo $options['apss_social_networks_naming'][$key]; }else{ echo ucfirst($key); } ?></span>
									<span class='apss-share'><?php if(isset($options['share_texts']['common-short-text']) && $options['share_texts']['common-short-text'] !='' ){ echo $options['share_texts']['common-short-text']; }else{ _e( 'Share', APSS_TEXT_DOMAIN ); } ?></span>
							</div>
					</a>
			...
			<div class='apss-email apss-single-icon'>
				<a <?php if(isset($options['apss_email_share_popup_disable']) && $options['apss_email_share_popup_disable'] !='1'){ echo "class='share-email-popup'"; } ?> title='<?php if(isset($options['share_texts']['email-long-text']) && $options['share_texts']['email-long-text'] !='' ){ echo $options['share_texts']['email-long-text']; }else{ echo "Send email"; } ?>' target='<?php echo $apss_link_open_option; ?>' href='<?php echo $link; ?>'>
					<div class='apss-icon-block<?php if($icon_set_value != '4'){ ?> clearfix<?php } ?>'><i class='fa  fa-envelope'></i>
			...
			<div class='apss-print apss-single-icon'>
				<a title='<?php if(isset($options['share_texts']['print-long-text']) && $options['share_texts']['print-long-text'] !='' ){ echo $options['share_texts']['print-long-text']; }else{ echo "Print this"; } ?>' href='javascript:void(0);' onclick='window.print();return false;'>
					<div class='apss-icon-block<?php if($icon_set_value != '4'){ ?> clearfix<?php } ?>'><i class='fa fa-print'></i>
...
<div class="apss-total-sahre-count-wrap">
	...
	<span class='apss-shares-text'><?php echo _e( ' Shares', APSS_TEXT_DOMAIN ); ?></span></div></div>
</div>
<?php } ?>
</div>

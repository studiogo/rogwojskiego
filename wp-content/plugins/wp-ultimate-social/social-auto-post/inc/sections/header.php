<div class="asap-header clearfix">

  <div class="aps-col-title">

                <div class="us-title"><?php _e('Social Auto Post Dashboard', US_TD); ?></div>
...
<!--     <a href="<?php echo admin_url('admin.php?page=ultimate-social'); ?>"><?php _e('Dashboard', ASAP_TD ); ?></a> -->

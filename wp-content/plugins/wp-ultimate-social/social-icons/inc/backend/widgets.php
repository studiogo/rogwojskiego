 ...
 */
class APS_PRO_Widget extends WP_Widget {
    ...
    function __construct() {
        parent::__construct(
                'us_social_icons_widget', // Base ID
                __('Ultimate Social Icons', US_TD), // Name
                array('description' => __('Ultimate Social Icons Widget', US_TD),) // Args
        );
    }
    ...
    public function widget($args, $instance) {
        ...
        if ($instance['si_id'] != '') {
            ...
            echo do_shortcode('[us-social-icon id="' . $si_id . '"]');
        }
    ...
    public function form($instance) {
        ...
        <p>
            <label for="<?php echo $this->get_field_id('si_id'); ?>"><?php _e('Icon set', US_TD) ?></label>
